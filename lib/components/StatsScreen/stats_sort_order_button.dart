...
class StatsSortOrderButton extends ConsumerWidget {
  const StatsSortOrderButton({super.key, required this.tabType, this.sortOrderOverride, this.onOverrideChanged});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    var order = sortOrderOverride ?? (ref.watch(finampSettingsProvider.statsTabSortOrder(tabType)));
    return IconButton(
      ...
      onPressed: () {
        ...
        if (sortOrderOverride != null && onOverrideChanged != null) {
          ...
          FinampSetters.setStatsTabSortOrder(tabType, newOrder);
        }
      },
    );
  }
